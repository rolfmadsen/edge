...
## 📋 Acceptance Criteria
- [ ] **Kerne-datastrukturer og Begrebssporing (`src/features/information_model/`)**:
...
- [ ] **ModelProject & Disk-Persistens (`src/features/model/`)**:
...
- [ ] **Fane 4 UI: Master-Detail Editor (`src/ui/app.rs`)**:
