...
- [x] **AC3 (Inspector-kontroller)**: Når en informationsklasse er valgt i inspectoren, kan brugeren slå `Abstrakt` til/fra, skifte mellem `Lokal` og `Indlånt/Fremmed`, samt angive kildemodel/URI for indlånte klasser.
